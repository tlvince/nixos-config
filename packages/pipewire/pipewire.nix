...
assert ldacbtSupport -> bluezSupport; let
  ...
  self = stdenv.mkDerivation rec {
    ...
    src = fetchFromGitLab {
      ...
      owner = "pvir";
      repo = "pipewire";
      rev = "c3f1fcca4b1b4b223669cc1ba18bfb62f416ea54";
      sha256 = "sha256-NTMdRZ/diFoXNMi0WXvJIY5n6s0BJyakAkWHEY2qhBk=";
    };
    ...
    buildInputs =
      ...
      ++ (
        if lib.meta.availableOn stdenv.hostPlatform webrtc-audio-processing_1
        then [webrtc-audio-processing_1]
